# Rscript  args.R --stage='stage1 stage2 stage3 stage4' --metadata.file='0.metadata.csv' --atac.file='0.cre.csv' --atac.raw='YES' --rna.exists='YES' --rna.file='0.rna.csv' --rna.raw='YES' --genomeArg='hg19' --cutoff=90 --Hscore=75 --nCores=2 --task='222' --inputdir='/home/rstudio/kitematic/R/Dynamics/' --dir='/home/rstudio/kitematic/R/Dynamics/'
...
# 设置参数
parser$add_argument("--stage", type="character", default='stage1 stage2 stage3 stage4',
                    help="The names of cell stages for dynamics, separated by ' ' ")
