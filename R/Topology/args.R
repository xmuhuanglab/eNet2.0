# Rscript  args.R --atac.file='0.cre.csv' --atac.raw='YES' --rna.exists='YES' --rna.file='0.rna.csv' --rna.raw='YES' --genomeArg='hg19' --cutoff=90 --Hscore=75 --nCores=2 --task='xx' --inputdir='/home/rstudio/kitematic/R/Topology/' --dir='/home/rstudio/kitematic/R/Topology/'
